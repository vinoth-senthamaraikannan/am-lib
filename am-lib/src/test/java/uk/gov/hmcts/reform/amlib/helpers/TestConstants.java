...
public final class TestConstants {
    ...
    public static final String RESOURCE_KEY = "/child";
    public static final String RESOURCE_VALUE = "some resource data";
    public static final String RESOURCE_EXPECTED_KEY = "child";
